Pod::Spec.new do |spec|
  ...
  spec.resource_bundles      = { 'CTAssetsPickerController' => ['CTAssetsPickerController/Resources/CTAssetsPicker.xcassets/*.imageset/*.png', 'CTAssetsPickerController/Resources/zh-*.lproj'] }
