Pod::Spec.new do |s|
  ...
  s.platform     		= :ios, '7.0'
  s.source       		= { :git => "https://github.com/chiunam/CTAssetsPickerController.git", :tag => "v2.8.0" }
  s.source_files 		= "CTAssetsPickerController/*.{h,m}"
  s.resource_bundles     		= { "CTAssetsPickerController" => ["CTAssetsPickerController/CTAssetsPicker.xcassets/*/*.png", "CTAssetsPickerController/*.lproj"] }
